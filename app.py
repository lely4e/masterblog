...
POSTS = data_storage.load_data("data/data.json")
...
def add():
    ...
    if request.method == "POST":
        ...
        # Check data
        return utils_func.check_data(data_storage.POSTS, "Can't save post")
...
def delete(post_id):
    ...
    for post in data_storage.POSTS:
        if post["id"] == post_id:
            ...
            # Check data
            return utils_func.check_data(data_storage.POSTS, "Can't delete post")
...
def update(post_id):
    ...
    post = utils_func.fetch_post_by_id(post_id)
    if post is None:
        # Post not found
        return "Post not found", 404
    ...
    if request.method == "POST":
        ...
        for post in data_storage.POSTS:
            if post["id"] == post_id:
                ...
                # Check data
                return utils_func.check_data(data_storage.POSTS, "Can't update post")
...
def likes(id):
    ...
    for post in data_storage.POSTS:
        if post["id"] == id:
            ...
            # Check data
            return utils_func.check_data(data_storage.POSTS, "Can't update likes")
